...
const SearchBar = () => (
  <div className="search-container">
    ...
    <input className="search" type="text" placeholder="Procure cliente" />
  </div>
);
...
const WhiteRectangle = () => (
  <div className="white-rectangle">
    ...
    <div className="nome-label">Solução</div>
    <div className="nome-label">Valor Contrato</div>
    <div className="nome-label">Início Contrato</div>
    
    <div className="horizontal-line-2" style={{ marginTop: '50px', marginBottom: '15px' }} />
    ...
    <div style={{ display: 'flex', alignItems: 'center', textAlign: 'center', position: 'relative', margin: '10px'}}>
      <span className="nome-label">Nathan Marques</span>
      <span className="nome-label">012.345.678-91</span>
      <span className="nome-label">Backup Nuvem</span>
      <span className="nome-label">R$200,00</span>
      <span className="nome-label">28/03/2024</span>
    </div>
    <div className="horizontal-line-2" style={{ marginTop: '18px'}} />
  </div>
);
  ...
  return (
    <div className="app-container">
      <div className="caixa-1">
        <p className="clientes">Contratos</p>
      </div>
      {showSolutions ? (
        ...
        <>
          <div className='caixa-4'>
            <SearchBar />
            <button className="green-button text-black">Adicionar Contrato</button>
